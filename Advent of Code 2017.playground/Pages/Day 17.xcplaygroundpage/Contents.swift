...
let part1Iterations = 2_017

let example = solvePart1(iterations: part1Iterations, step: 3)
assert(example == 638)

let answer1 = solvePart1(iterations: part1Iterations, step: input)
 ...
 */
let part2Iterations = 50_000_000

let answer2 = solvePart2(iterations: part2Iterations, step: input)
