 ...
 */
let input = loadInput().trimmingCharacters(in: .whitespacesAndNewlines)
let lines = input.components(separatedBy: .newlines)
let particles = lines.flatMap(Particle.init)
assert(particles.count == lines.count)

let answer1 = runPart1(particles: particles)
