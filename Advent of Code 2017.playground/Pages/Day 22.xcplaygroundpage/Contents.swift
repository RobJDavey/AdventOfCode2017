...
...
"""
let exampleStartInfo = parse(example)
let example1 = run(startInfo: exampleStartInfo, count: 10_000, transform: part1Transformation)
assert(example1 == 5_587)

let input = loadInput()
let startInfo = parse(input)
let answer1 = run(startInfo: startInfo, count: 10_000, transform: part1Transformation)
 ...
 */
let example2 = run(startInfo: exampleStartInfo, count: 10_000_000, transform: part2Transformation)
assert(example2 == 2_511_944)
